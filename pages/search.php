...
<body>
   ...
   <div id="search">
    ...
    <?php
        ...
        //instancia
        $crud = new ClassCrud();
        $carros = filter_input(INPUT_POST,'carros',FILTER_SANITIZE_SPECIAL_CHARS);
        $row = $crud->selectDB("*","abastecimentoDois","where carros like ?",array("%$carros%"));
        //foreach
        foreach($row->fetchAll(PDO::FETCH_ASSOC) as $rows){
            ...
            $media = $fuel / $rows['litros_abastecimento'];
        ?>
                <tr>
